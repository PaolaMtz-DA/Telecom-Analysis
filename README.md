...
-usuarios.csv : Información demográfica de los clientes (edad, tipo de plan, etc.).

-use.csv : Registro de uso de llamadas y mensajes.
...
-Visualización : histogramas y boxplots para entender distribuciones y detectar valores extremos.

-Segmentación de clientes : clasificación por nivel de uso (bajo, medio, alto) y por edad (joven, adulto, adulto mayor).
...
-Asegúrate de cargar los conjuntos de datos en el entorno de Colab (puedes subirlos manualmente o montando Google Drive).
...
Verifique que los conjuntos de datos estén en la misma carpeta que el cuaderno.

Corre cada celda paso a paso para replicar el flujo de análisis y obtener las visualizaciones y segmentaciones.
